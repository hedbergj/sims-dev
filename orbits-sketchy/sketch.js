...
mass1 =  orbiters.push(new Orbiter(createVector(width/2,-200+height/2),createVector(v1,0),createVector(0,0),100, 200));
mass2 = orbiters.push(new Orbiter(createVector(width/2,height/2),createVector(-v1/massRatio,0),createVector(0,0),100*massRatio, 200));
